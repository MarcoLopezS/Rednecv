...
<div class="wrapper">
  ...
  <!-- banner -->
  <section id="banner" class="inner-b"> <img src="images/404_01.png" width="100%" height="90" alt=""> </section>
  <!-- Content -->
  <section class="content-holder1 inner-pages">
    <section class="container">
      <section class="help-holder">
        <article class="left">
          <h2> <span class="txt-left">404 Error</span> <span class="bg-right"></span> </h2>
          <p>This page was not found, page is missing or moved.</p>
      ...
      <section class="top">
        <section class="row-fluid">
          ...
          <figure class="span3 b-post">
            ...
            <div class="f-img-holder"> <img src="images/image18.jpg" class="f-blog-img" alt="" /> <span class="p-date">22 <br>
              May</span> </div>
