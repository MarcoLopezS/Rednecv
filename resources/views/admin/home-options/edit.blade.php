	...
	<div class="col-lg-12">
		...
		<div class="portlet box blue-hoki">
            ...
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-globe"></i>Opciones de Home - Editar
                </div>
            </div>

			<div class="portlet-body form">
				{!! Form::model($post, ['route' => ['admin.home.options.update', $post->id], 'method' => 'PUT', 'class' => 'form-horizontal form-bordered', 'files' => 'true']) !!}
