                    ...
                    <div class="panel panel-info" style="overflow:auto;">
                        ...
                        <div class="panel-body" style="padding:0px !important;">
                            <div class="col-md-12" style="padding:30px; float:center;">
                                {!! Form::open(['route' => ['admin.post.photosStore', $posts->id], 'method' => 'POST', 'class' => 'dropzone']) !!}
                                {!! Form::close() !!}
                            </div>
                        </div>
                    </div>

                    <a href="{{ route('admin.post.photosList', $posts->id) }}" class="btn btn-primary">Ver fotos de noticia</a>
