		...
		<div class="col-lg-12">
			...
			<div class="portlet box blue-hoki">
				...
				<div class="portlet-body form">
					...
					{!! Form::model($photo, ['route' => ['admin.post.photosUpdate', $posts->id, $photo->id], 'method' => 'PUT', 'class' => 'form-horizontal form-bordered', 'files' => 'true']) !!}
                        ...
                        <div class="form-group">
                            <div class="col-md-12 text-right">
                                ...
                                <a href="{{ route('admin.post.photosList', $posts->id) }}" class="btn btn-responsive btn-default btn-md">Cancelar</a>
                            </div>
                        </div>
