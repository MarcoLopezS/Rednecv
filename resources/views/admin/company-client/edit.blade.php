	...
	<div class="col-lg-12">
		...
		<div class="portlet box blue-hoki">
            ...
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-globe"></i>Clientes - Editar
                </div>
            </div>

			<div class="portlet-body form">
				{!! Form::model($post, ['route' => ['admin.company.client.update', $post->id], 'method' => 'PUT', 'class' => 'form-horizontal form-bordered', 'files' => 'true']) !!}
                    ...
                    <div class="form-group">
                        <div class="col-md-12 text-right">
                            ...
                            <a href="{{ route('admin.company.client.index') }}" class="btn btn-responsive btn-default btn-md">Cancelar</a>
                        </div>
                    </div>
