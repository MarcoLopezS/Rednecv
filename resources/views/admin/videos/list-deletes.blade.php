        ...
        <div class="col-lg-12">
            ...
            <div class="portlet box blue-hoki">
                ...
                <div class="portlet-body">
                    ...
                    {!! Form::model(Request::all(), ['route' => 'admin.gallery.video.listsDeletes', 'method' => 'GET']) !!}
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center col-md-2">
                                        ...
                                        <a href="{!! route('admin.gallery.video.listsDeletes') !!}" class="btn btn-danger">
...
{!! Form::open(['route' => ['admin.gallery.video.listsDeletes.destroy', ':REGISTER'], 'method' => 'DELETE', 'id' => 'FormDeleteRow']) !!}
{!! Form::close() !!}
...
{!! Form::open(['route' => ['admin.gallery.video.listsDeletes.restore', ':REGISTER'], 'method' => 'POST', 'id' => 'FormRestoreRow']) !!}
{!! Form::close() !!}
