			...
			<div class="portlet box blue-hoki">
				...
				<div class="portlet-body">
                    ...
                    <div class="table-toolbar">
                        ...
                        <div class="btn-group">
                            <a href="{{ route('admin.gallery.video.create') }}" class="btn green">
                                Agregar registro
                        ...
                        <div class="btn-group">
                            <a href="{{ route('admin.gallery.video.listsDeletes') }}" class="btn red">
                    ...
                    {!! Form::model(Request::all(), ['route' => 'admin.gallery.video.index', 'method' => 'GET']) !!}
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center col-md-2">
                                        ...
                                        <a href="{!! route('admin.gallery.video.index') !!}" class="btn btn-danger">
                                ...
                                <td class="text-center">
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            <li><a href="{{ route('admin.gallery.video.edit', $item->id) }}">Editar</a></li>
                                            <li><a class="btn-delete" href="#delete">Eliminar</a></li>
                                            <li><a href="@{{ route('admin.gallery.video.history', $item->id) }}">Historial</a></li>
                                        </ul>
                                    </div>
                                </td>
                            </tr>
...
{!! Form::open(['route' => ['admin.gallery.video.destroy', ':REGISTER'], 'method' => 'DELETE', 'id' => 'FormDeleteRow']) !!}
{!! Form::close() !!}
