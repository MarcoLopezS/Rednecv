            ...
            <div class="portlet box blue-hoki borderNone">
                ...
                <div class="portlet-body">   
                    ...
                    <div class="table-toolbar">
                        ...
                        <div class="btn-group">
                            <a href="{{ route('admin.slider.create') }}" class="btn green">
                                Agregar registro
                    ...
                    <div class="table-toolbar">
                        ...
                        {!! Form::open(['route' => 'admin.slider.order', 'method' => 'POST', 'id' => 'FormOrder']) !!}
                        ...
                        <ul id="listPhotos" class="unstyled">
                            ...
                            <li data-id="{{ $item->id }}" data-title="{{ $item->titulo }}" class="col-lg-2 col-md-3 col-xs-6 col-sm-3 gallery-border">
                                ...
                                <div class="slider-options">
                                    ...
                                    <a href="{{ route('admin.slider.edit', $item->id) }}" title="Editar">
...
{!! Form::open(['route' => ['admin.slider.destroy', ':REGISTER'], 'method' => 'DELETE', 'id' => 'FormDeleteRow']) !!}
{!! Form::close() !!}
