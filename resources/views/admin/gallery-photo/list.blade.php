			...
			<div class="portlet box blue-hoki">
				...
				<div class="portlet-body">
                    ...
                    <div class="table-toolbar">
                        ...
                        <div class="btn-group">
                            <a href="{{ route('admin.gallery.photo.create') }}" class="btn green">
                                Agregar registro
                    ...
                    {!! Form::model(Request::all(), ['route' => 'admin.gallery.photo.index', 'method' => 'GET']) !!}
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center col-md-2">
                                        ...
                                        <a href="{!! route('admin.gallery.photo.index') !!}" class="btn btn-danger">
                    ...
                    <table class="table table-striped table-responsive">
                        ...
                        <tbody>
                            ...
                            <tr data-id="{{ $item->id }}" data-title="{{ $item->titulo }}">
                                ...
                                <td class="text-center">{{ date_format(new DateTime($item->published_at), 'd/m/Y H:i')  }}</td>
                                <td class="text-center">
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            <li><a href="{{ route('admin.gallery.photo.edit', $item->id) }}">Editar</a></li>
                                            <li><a class="btn-delete" href="#delete">Eliminar</a></li>
                                            <li><a href="{{ route('admin.gallery.photo.photosList', $item->id) }}">Galería de Fotos</a></li>
                                        </ul>
                                    </div>
                                </td>
                            </tr>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5 col-sm-12">
                            <div class="dataTables_info" id="table1_info" role="status" aria-live="polite">Total de registros: {{ $gallery->total() }}</div>
                        </div>

                        <div class="col-md-7 col-sm-12">
                            <div class="pull-right dataTables_paginate paging_simple_numbers" id="table1_paginate">
                                {!! $gallery->appends(Request::all())->render() !!}
                            </div>
...
{!! Form::open(['route' => ['admin.gallery.photo.destroy', ':REGISTER'], 'method' => 'DELETE', 'id' => 'FormDeleteRow']) !!}
{!! Form::close() !!}
