  ...
  <section class="content-holder1 inner-pages">
    <section class="container">
      <section class="help-holder">
        <article class="left">
          <h2> <span class="txt-left">Author</span> <span class="bg-right"></span> </h2>
          <section class="row-fluid">
            <figure class="span8">
              <article class="author-art main"> <strong class="title">John Ken</strong>
                <div class="author-inner main">
                  <ul class="tbs">
                    <li><a href="#">Most Recent</a></li>
                    <li><a href="#">Most Commented</a></li>
                    <li><a href="#">Alphabetical</a></li>
                  </ul>
                  <img src="images/image23.jpg" class="team-img" alt=""/>
                  <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electer setting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum. There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable.</p>
                </div>
              </article>
              <article class="author-art"> <strong class="title2"><a href="#">Create A WordPress Archives Template for Your Theme</a></strong>
                <div class="author-inner"><img src="images/image20.jpg" class="team-img margin" alt=""/><strong class="art-link"><a href="#">Tutorials </a>/ <a href="#">Theme Development </a>/ Rating</strong>
                  <p>The standard chunk of Lorem Ipsum used since the 1500s is reproduced below for those interested. Sections 1.10.32 and 1.10.33 from &quot;de Finibus Bonorum et Malorum&quot; by Cicero are also reproduced in their exact original form, accompanied. read more.<a href="#"> <strong>read more</strong></a></p>
                  <br class="clear">
                  <div class="art-bottom"> Chris Adam on June 17th 2012 with 14 comments </div>
                </div>
              </article>
              <article class="author-art"> <strong class="title2"><a href="#">Create A WordPress Archives Template for Your Theme</a></strong>
                <div class="author-inner"><img src="images/image41.jpg" class="team-img" alt=""/><strong class="art-link"><a href="#">Tutorials </a>/ <a href="#">Theme Development </a>/ Rating</strong>
                  <p>The standard chunk of Lorem Ipsum used since the 1500s is reproduced below for those interested. Sections 1.10.32 and 1.10.33 from &quot;de Finibus Bonorum et Malorum&quot; by Cicero are also reproduced in their exact original form, accompanied. read more.<a href="#"> <strong>read more</strong></a></p>
                  <br class="clear">
                  <div class="art-bottom"> Chris Adam on June 17th 2012 with 14 comments </div>
                </div>
