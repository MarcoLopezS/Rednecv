...
<html lang="en">
<head>
<title>Blog double sidebar</title>
          ...
          <div class="navbar-inner">
            ...
            <div class="nav-collapse collapse">
              <ul class="nav">
                ...
                <li class="dropdown active"> <a class="dropdown-toggle" href="#" data-toggle="dropdown">Blog <b class="caret"></b> </a>
                  <ul class="dropdown-menu">
                    <li><a href="blog.html">Blog</a></li>
                    <li><a href="blog-detail.html">Blog Detail</a></li>
                    <li class="active"><a href="blog-double-sidebar.html">Blog Double Sidebar</a></li>
                  </ul>
                </li>
      ...
      <section class="help-holder">
        <article class="left">
          ...
          <section class="row-fluid content-holder">
            ...
            <figure class="span3">
              <h3>Latest News</h3>
              <article class="news-h"> <img class="team-img" src="images/image21.jpg" alt=""/>
                <p>Nunc nec neque. Phasellus leo dolor, tempus non, auctor et, hendrerit quis, nisi. Curabitur ligula sapien, tincidunt non, euismod vitae, posuere imperdiet, leo. Maecenas malesuada. Curabitur ligula tincidunt non, euismod vitae, posuere imperdiet, leo. Maecenas malesuada. Praesent congue erat at massa.</p>
              </article>
              <article class="news-h"> <img class="team-img" src="images/image21.jpg" alt=""/>
                <p>Nunc nec neque. Phasellus leo dolor, tempus non, auctor et, hendrerit quis, nisi. Curabitur ligula sapien, tincidunt non, euismod vitae, posuere imperdiet, leo. Maecenas malesuada. Curabitur ligula tincidunt non, euismod vitae, posuere imperdiet, leo. Maecenas malesuada. Praesent congue erat at massa.</p>
              </article>
            ...
            <figure class="span6">
              <article class="author-art">
                <div class="author-inner"><img src="images/image20.jpg" class="team-img" alt=""/><strong class="title2"><a href="#">Create A WordPress Archives Template for Your Theme</a></strong>
                  <p>Nam sed nibh tellus, eu tempor metus. Donec ornare elit ac lectus molestie lobortis. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Nunc lorem orci, suscipit quis congue eget, euismod in enim. Suspendisse pulvinar pretium eleifend. Duis venenatis eros id libero imperdiet consectetur Lorem ipsum dolor sit amet, consectetur adipiscing elit. In viverra orci eget velit vulputate ...</p>
                  <br class="clear">
                  <div class="blog-bottom">
                    <ul class="b-top-links">
                      <li>25 Aug, 2012</li>
                      <li class="author-name"><a href="#">By: Admin</a></li>
                      <li class="comments2"><a href="#">4 Comments</a></li>
                      <li class="design-icon"><a href="#">Graphic Design</a></li>
                    </ul>
                  </div>
                </div>
              </article>
              <article class="author-art">
                <div class="author-inner"><img src="images/image41.jpg" class="team-img" alt=""/><strong class="title2"><a href="#">Create A WordPress Archives Template for Your Theme</a></strong>
                  <p>Nam sed nibh tellus, eu tempor metus. Donec ornare elit ac lectus molestie lobortis. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Nunc lorem orci, suscipit quis congue eget, euismod in enim. Suspendisse pulvinar pretium eleifend. Duis venenatis eros id libero imperdiet consectetur Lorem ipsum dolor sit amet, consectetur adipiscing elit. In viverra orci eget velit vulputate ...</p>
                  <br class="clear">
                  <div class="blog-bottom">
                    <ul class="b-top-links">
