              ...
              <ul class="nav">
                ...
                <li class="dropdown active"> <a class="dropdown-toggle" href="#" data-toggle="dropdown">Gallery <b class="caret"></b> </a>
                  <ul class="dropdown-menu">
                    ...
                    <li class="active"><a href="right-bar-gallery.html">Right Bar Gallery</a></li>
                  </ul>
                </li>
  ...
  <section class="content-holder1 inner-pages">
    <section class="container">
      <section class="help-holder">
        <article class="left">
          <h2> <span class="txt-left">Right Content Portfolio</span> <span class="bg-right"></span> </h2>
          <section class="row-fluid content-holder">
            <figure class="span8">
              <section class="row-fluid content-gallery">
                <figure class="span6 first"> <a data-toggle="lightbox" href="#gallery_1" > <img class="team-img f-width-img" src="images/gallery_1.jpg" alt=""/> </a>
                  <p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia.</p>
                </figure>
                <figure class="span6"> <a data-toggle="lightbox" href="#gallery_2"> <img class="team-img f-width-img" src="images/gallery_2.jpg" alt=""/> </a>
                  <p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia.</p>
                </figure>
                <figure class="span6 first"> <a data-toggle="lightbox" href="#gallery_3" > <img class="team-img f-width-img" src="images/gallery_3.jpg" alt=""/> </a>
                  <p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia.</p>
                </figure>
                <figure class="span6"> <a data-toggle="lightbox" href="#gallery_4" > <img class="team-img f-width-img" src="images/gallery_4.jpg" alt=""/> </a>
                  <p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia.</p>
                </figure>
                <figure class="span6 first"> <a data-toggle="lightbox" href="#gallery_5" > <img class="team-img f-width-img" src="images/gallery_5.jpg" alt=""/> </a>
                  <p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia.</p>
                </figure>
                <figure class="span6"> <a data-toggle="lightbox" href="#gallery_6"> <img class="team-img f-width-img" src="images/gallery_6.jpg" alt=""/> </a>
                  <p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia.</p>
                </figure>
              </section>
