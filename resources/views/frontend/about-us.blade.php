  ...
  <section class="content-holder1 inner-pages">
    <section class="container">
      <section class="help-holder">
        <article class="left">
          <h2> <span class="txt-left">About Us</span> <span class="bg-right"></span> </h2>
          <p><img src="images/image19.jpg" class="content-img" alt=""/> Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua.At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua.AContrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia, looked up one of the more obscure Latin words, consectetur, from a Lorem Ipsum passage, and going through the cites of the word in classical literature, discovered the undoubtable source. Lorem Ipsum comes from sections 1.10.32 and 1.10.33 of "de Finibus Bonorum et Malorum" (The Extremes of Good and Evil) by Cicero, written in 45 BC. from a line in section 1.10.32. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet.</p>
          <p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet.</p>
          <h2>Our Services</h2>
          <ul class="normal-list">
            <li>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</li>
            <li>Maecenas posuere tellus nec purus blandit eget congue enim congue.</li>
            <li>Mauris dapibus turpis nec nisl mollis iaculis.</li>
            <li>Pellentesque ornare ante non nisl dignissim egestas.</li>
            <li>Sed faucibus nibh ac nisi faucibus nec faucibus tortor mollis.</li>
          </ul>
          <h2>Our Clients</h2>
          <section class="row-fluid clients-logos">
            <figure class="span3 first"> <a href="#"><img src="images/image29.jpg" alt="" class="content-img f-width-img"></a> </figure>
            <figure class="span3"> <a href="#"><img src="images/image30.jpg" alt="" class="content-img f-width-img"></a> </figure>
            <figure class="span3"> <a href="#"><img src="images/image31.jpg" alt="" class="content-img f-width-img"></a> </figure>
            <figure class="span3"> <a href="#"><img src="images/image32.jpg" alt="" class="content-img f-width-img"></a> </figure>
            <figure class="span3 first"> <a href="#"><img src="images/image33.jpg" alt="" class="content-img f-width-img"></a> </figure>
            <figure class="span3"> <a href="#"><img src="images/image34.jpg" alt="" class="content-img f-width-img"></a> </figure>
            <figure class="span3"> <a href="#"><img src="images/image35.jpg" alt="" class="content-img f-width-img"></a> </figure>
            <figure class="span3"> <a href="#"><img src="images/image36.jpg" alt="" class="content-img f-width-img"></a> </figure>
          </section>
        </article>
      </section>
    </section>
