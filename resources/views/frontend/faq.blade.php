  ...
  <section class="content-holder1 inner-pages">
    <section class="container">
      <section class="help-holder">
        <article class="left">
          <h2> <span class="txt-left">FAQ</span> <span class="bg-right"></span> </h2>
          <section class="row-fluid content-holder">
            <figure class="span8">
              <div class="accordion" id="accordion2">
                <div class="accordion-group">
                  <div class="accordion-heading"> <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseOne"> Q. Vestibulum at velit diam. Donec et est vel lorem egestas hendrerit? </a> </div>
                  <div id="collapseOne" class="accordion-body collapse in">
                    <div class="accordion-inner">
                      <p>Maecenas neque est, feugiat quis porta in, condimentum eget arcu. Maecenas fringilla aliquam ultricies. Pellentesque vel turpis nec leo tincidunt sollicitudin ac non risus. Ves tibu lum ultrices feugiat velit, quis tincidunt velit volutpat nec. Vivamus pharetra fringilla augue, a elementum ante ultrices tincidunt. Ut mi ligula, interdum utgtu fgdvcy pharetra id, Nunc molestie nisl id nunc sagittis quis fringilla ligula dignissim. </p>
                      <p>Suspendisse ac arcu tortor. Morbi placerat dictum turpis sed placerat. Suspendisse feugiat dapibus nibh et convallis. Duis ullamcorper justo a felis volutpat vel feugiat purus tristique. Curabitur posuere blandit iaculis. Quisque lacinia risus sapien, id ultricies dolor. Quisque ac risus lorem, in egestas metus. Sed ultrices euismod mattis. </p>
                    </div>
                  </div>
                </div>
                <div class="accordion-group">
                  <div class="accordion-heading"> <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseTow"> Q. Vestibulum at velit diam. Donec et est vel lorem egestas hendrerit? </a> </div>
                ...
                <div class="accordion-group">
                  <div class="accordion-heading"> <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseThree"> Q. Vestibulum at velit diam. Donec et est vel lorem egestas hendrerit? </a> </div>
                ...
                <div class="accordion-group">
                  <div class="accordion-heading"> <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseForth"> Q. Vestibulum at velit diam. Donec et est vel lorem egestas hendrerit? </a> </div>
                ...
                <div class="accordion-group">
                  <div class="accordion-heading"> <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseFive"> Q. Vestibulum at velit diam. Donec et est vel lorem egestas hendrerit? </a> </div>
                ...
                <div class="accordion-group">
                  <div class="accordion-heading"> <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseSix"> Q. Vestibulum at velit diam. Donec et est vel lorem egestas hendrerit? </a> </div>
                ...
                <div class="accordion-group">
                  <div class="accordion-heading"> <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseSeven"> Q. Vestibulum at velit diam. Donec et est vel lorem egestas hendrerit? </a> </div>
                ...
                <div class="accordion-group">
                  <div class="accordion-heading"> <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseEight"> Q. Vestibulum at velit diam. Donec et est vel lorem egestas hendrerit? </a> </div>
