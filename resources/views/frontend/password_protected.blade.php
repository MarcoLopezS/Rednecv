...
<html lang="en">
<head>
<title>Protected: Password: def45</title>
            ...
            <div class="nav-collapse collapse">
              <ul class="nav">
                ...
                <li class="dropdown active"> <a class="dropdown-toggle" href="#" data-toggle="dropdown">Features <b class="caret"></b> </a>
                  <ul class="dropdown-menu">
                    <li class="active"><a href="password_protected.html">Password Protected</a></li>
    ...
    <section class="container">
      <section class="help-holder">
        <article class="left">
          ...
          <p>This site is password protected. Enter your password here.</p>
          <h3>Paaword</h3>
